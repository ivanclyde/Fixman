    ...
    if(mysqli_num_rows($sqlemail) > 0) 
        {
          ...
          else
          {
            ...
            else 
            {
                ...
                {
                    $display = "INSERT INTO users(fname, mname, lname, age, bdate, address, contactno, gender, username, password, email, user_type, profilepix, code, status) values('$fname','$mname','$lname','$age','$bdate','$address','$contactno','$gender','$username','$password','$email','$user_type','$profilepix','$code','Not yet Verified')";
                    $dis = mysqli_query($database, $display);

                    $to = $email;
                    $subject = "Email Verification";
                    $message = "Welcome to FIX-MAN. Verify your account 
                    <a href='http://localhost/fixman/verify.php?code=$code'>here.</a>";
                    ...
                    echo "<script>alert('Please check your email for verification'); window.location.href='../login.php'</script>";
                }
            }
          }
    }
    ...
    <div class="row">
        ...
        <div class="col-md-8 register-right" >
            <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="client.php" role="tab" aria-controls="home" aria-selected="true">Client</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="repairman.php" role="tab" aria-controls="profile" aria-selected="false">Repairman</a>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
            <form action="#.php" method="post" enctype="multipart/form-data">
                <div class="tab-pane fade show active" id="client" role="tabpanel" aria-labelledby="home-tab">
                    <h3 class="register-heading">Apply as  Client</h3>
