<?php
	...
	$result = mysqli_query($database, "SELECT * FROM repairman WHERE status = 'Approved' ORDER BY repairmanid DESC");

	if (isset($_GET['repairmanid'])) 
	{
		$repairmanid = $_GET['repairmanid'];

		$sql = "DELETE FROM repairman WHERE repairmanid = '$repairmanid'";
		$res = mysqli_query($database, $sql);

		echo "<script>alert('Repairman Deleted Successfully'); window.location.href='adminviewrepairman.php';</script>";
	}
...
<div class="row" style="margin-top:-15px">
	<div class="col-sm-3 text-center" style="background-color:#F1F1F1;height:553px"><br>
		...
		<a class="btn btn-warning" href="adminviewrepairman.php">View All Repairman</a><br>
	...
	<div class="col-md-7">
		<div class="panel panel-default" style="width:1000px">
		  <div class="panel-heading" align="center"><h4><b>List of all Repairman</b></h4></div>
			  ...
			  <tbody>
			    <?php
					while ($res = mysqli_fetch_array($result))
					{
						...
						echo "<td><a style='width:40px' class='btn btn-success' href=\"adminviewrepairmanprofile.php?repairmanid=$res[repairmanid]\"><span class='glyphicon glyphicon-eye-open'></span></a> | <a style='width:40px' class='btn btn-success' href=\"adminviewrepairman.php?repairmanid=$res[repairmanid]\"onClick=\"return confirm('Are you sure you want to delete repairman?')\"><span class='glyphicon glyphicon-trash'></span></a></td>";
						echo '</tr>';
					}
				?>
			  </tbody>
