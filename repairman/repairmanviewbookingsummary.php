<?php
  ...
  while ($use = mysqli_fetch_array($users)) 
  {
    $cfname = $use['fname'];
    $clname = $use['lname'];
    $caddress = $use['address'];
    $ccontactno = $use['contactno'];
    $cemail = $use['email'];
  ...
  <div class="row content">
    <div class="col-lg-12" align="left">
      ...
      <div align="left" style="background-color:#F7FAFF;width:900px;border-radius:10px;margin-left:225px">
        <center><label style="padding-top:10px;background-color:#bdd5fc;width:900px;border-radius:10px"><b><h2><i class="bi bi-person"></i> Client Details</h2></b></label></center>
          <table style="margin-left:150px">
            <tr>
              <td style="width:250px"><div class="img_div">
                  <img src="../profilepix/<?php echo $cprofilepix ?>" width ="150px" height="150px" style="border-radius:100px">
              </div></td>
              <td>
                <label><b>Name : </b><?php echo $cfname; echo '&nbsp&nbsp'; echo $clname;?></label><br>
                <label><b>Address : </b><?php echo $caddress;?></label><br>
                <label><b>Contact Number : </b><?php echo $ccontactno;?></label><br>
                <label><b>Email : </b><?php echo $cemail;?></label><br>
              </td>
            </tr>
          </table><br>
        <center>
        <label style="padding-top:10px;background-color:#bdd5fc;width:900px;border-radius:10px"><b><h2><i class="bi bi-calendar-range"></i> Booking Details</h2></b></label>
          ...
          <tr>
            ...
            <td><?php echo $fname; echo'&nbsp'; echo $rlname;?></td>
          </tr>
      		<tr>
            <td><b>Client Name</b></td>
            <td><?php echo $cfname; echo'&nbsp'; echo $clname;?></td>
          </tr>
          <tr>
            <td><b>Address</b></td>
        ...
        <?php 
          while ($rows = mysqli_fetch_array($resultfeedback))
          {
            ...
            echo '<td rowspan="3" width="70px""><img class="img-dis" src="../profilepix/'.$cprofilepix.'"style="border-radius:50px;width: 80px;height: 80px;margin-top: 10px;"></td>';
            echo '<th class="text-left">'.$cfname.' '.$clname.'</th>';
