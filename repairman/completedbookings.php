<?php
	...
	$result = mysqli_query($database, "SELECT * FROM booking WHERE repairmanid = '$_SESSION[repairmanid]' AND status ='Complete' OR status = 'Canceled' OR status = 'Declined' ORDER BY no ASC");
...
<div>
	<ul class="nav justify-content-center">
	  <li class="nav-item">
	    <a class="nav-link active" href="repairmanviewbookings.php">Ongoing</a>
	  </li>
	  <li class="nav-item">
	    <a class="nav-link">|</a>
	  </li>
		...
		<center><table class="table table-striped" style="width:1300px">
			...
			while ($row = mysqli_fetch_array($result))
			{
				...
				while ($user = mysqli_fetch_array($users)) 
				{
					...
					{
						echo "<td align='center' style='background-color:#6698FF'><b>".$row['status']."</b></td>";
						echo '<td align="center"><a href="repairmanviewbookingsummary.php?bookingid='.$row['bookingid'].'&userid='.$row['userid'].'"><i class="bi bi-eye"></i></a></td></tr>';
					}
				}
			}
			?>
