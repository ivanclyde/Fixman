...
if (isset($_POST['submit'])) 
{
			...
			$message = "Hello Good Day, <br><br>

						Someone (hopefully you!) submitted a request to reset your password. If it wasn't you, please ignore this message. If it was you, you can reset your password at the below link.<br><br>

						FIX-MAN Team <br><br>
 
			<a href='http://localhost/fixman/resetpassword.php?email=$email'>Reset here.</a>";
			...
			echo "<script>alert('Verify your account.'); window.location.href='login.php?'</script>";
}
			...
			<div class="card-body">
				<form id="reset-password" class="form" action="#.php" method="post">
					...
					<div class="form-group">
						<input type="Submit" name="submit" value="Reset Password" class="btn float-right login_btn" style="width:200px !important">
					</div>
				</form>
			</div>
